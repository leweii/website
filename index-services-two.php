        ...
        <div class="row">
            <div class="col-md-12">
                <div class="section-title">
                    ...
                    <?php }
                    if ($current_options['service_tagline'] != '') { ?>
        ...
        <div id="service_content" class="row">
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="post">
                    ...
                    <div class="service-icon"><i class="fa <?php echo $current_options['service_icon_one']; ?>"></i>
                        <?php } else {
                            ...
                            <?php if ($current_options['service_image_one'] != '') { ?>
                                <img class="services_cols_mn_icon" alt="Web Design"
                                     src="<?php echo esc_url($current_options['service_image_one']); ?>">
                            <?php }
                        } ?>
                    </div>
                    ...
                    <?php }
                    if ($current_options['service_text_one'] != '') { ?>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="post">
                    ...
                    <div class="service-icon"><i class="fa <?php echo $current_options['service_icon_two']; ?>"></i>
                        <?php } else {
                            ...
                            <?php if ($current_options['service_image_two'] != '') { ?>
                                <span><img class="services_cols_mn_icon" alt="Web Design"
                                           src="<?php echo esc_url($current_options['service_image_two']); ?>"></span>
                            <?php }
                        } ?>
                    </div>
                    ...
                    <?php }
                    if ($current_options['service_text_two'] != '') { ?>
                        <div class="entry-content">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="post">
                    ...
                    <div class="service-icon"><i class="fa <?php echo $current_options['service_icon_three']; ?>"></i>
                        <?php } else {
                            ...
                            <?php if ($current_options['service_image_three'] != '') { ?>
                                <span><img class="services_cols_mn_icon" alt="Web Design"
                                           src="<?php echo esc_url($current_options['service_image_three']); ?>"></span>
                            <?php }
                        } ?>
                    </div>
                    ...
                    <?php }
                    if ($current_options['service_text_three'] != '') { ?>
                        <div class="entry-content">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="post">
                    ...
                    <div class="service-icon"><i class="fa <?php echo $current_options['service_icon_four']; ?>"></i>
                        <?php } else {
                            ...
                            <?php if ($current_options['service_image_four'] != '') { ?>
                                <span><img class="services_cols_mn_icon" alt="Web Design"
                                           src="<?php echo esc_url($current_options['service_image_four']); ?>"></span>
                            <?php }
                        } ?>
                    </div>
                    ...
                    <?php }
                    if ($current_options['service_text_four'] != '') { ?>
                        <div class="entry-content">
