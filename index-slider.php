                    ...
                    <li>
                        ...
                        <div class="container">
                            <div class="slide-caption">
                                ...
                                <?php } else { ?>
                                    <h2><?php echo esc_html($current_options['caption_head']); ?></h2> <?php }
                                ...
                                <?php }
                                if ($slide_options['link'] != '') { ?>
                                    <div><a href="<?php echo esc_url($slide_options['link']); ?>" <?php if (
                                            $slide_options['open_new_tab'] == 'yes') {
                                            echo "target='_blank'";
                                        } ?> class="flex-btn"><?php echo esc_html($slide_options['button_text']); ?></a>
                                    </div>
                                <?php } else { ?>
                                    <?php if ($current_options['readmore_text_link'] != '') { ?>
                                        <div><a href="<?php echo esc_url($current_options['readmore_text_link']); ?>"
                                                target="_blank"
                                                class="flex-btn"><?php echo esc_html($current_options['readmore_text']); ?></a>
                                        </div>
                                    <?php } ?>
