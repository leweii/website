                ...
                <div class="carousel-inner">
                    ...
                    if ($testimonial_options != '') {
                        foreach ($testimonial_options as $testimonial_iteam) {
                            ...
                            ?>
                            <div class="col-md-12 pull-left item <?php if ($t == true) {
                                echo 'active';
                            }
                            $t = false; ?>">
                                <div class="post">
                                    ...
                                    <figure class="post-thumbnail">
                                        <a href="<?php echo $test_link; ?>" <?php if ($open_new_tab == 'yes') {
                                            echo 'target="_blank"';
                                        } ?>>
                                            <img alt="img" class="img-responsive"
                                                 src="<?php echo $testimonial_iteam->image_url; ?>" draggable="true">
                                        </a>
                                    </figure>
                                    ...
                                    <div class="media">
                                        <div class="media-body">
                                            <span class="author-name"> <a
                                                        href="<?php echo $test_link; ?>" <?php if ($open_new_tab == 'yes') {
                                                    echo 'target="_blank"';
                                                } ?>> <?php echo $testimonial_iteam->title; ?> </a> <small
                                                        class="designation"><?php echo $designation; ?></small></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        for ($i = 0; $i <= 3; $i++) { ?>
                            <div class="col-md-12 pull-left item <?php if ($i == 0) {
                                echo 'active';
                            } ?>">

                                <div class="post">
                                    <figure class="post-thumbnail"><img
                                                src="<?php echo get_template_directory_uri(); ?>/images/<?php echo $image[$i]; ?>.jpg"
                                                class="img-circle" alt="img"></figure>
                                    <div class="entry-content">
                                    ...
                                    <div class="media">
                                        <div class="media-body">
                                            <span class="author-name"><?php echo $name[$i]; ?>
                                                <small class="designation"><?php echo $desc[$i]; ?></small></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
