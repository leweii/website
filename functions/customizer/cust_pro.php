...
function busiprof_pro_customizer($wp_customize)
{
    class WP_Pro_Customize_Control extends WP_Customize_Control
    {
        ...
        public function render_content()
        {
            ?>
            <div class="pro-box">
                <a href="<?php echo esc_url('http://webriti.com/busiprof/'); ?>" target="_blank" class="upgrade"
                   id="review_pro"><?php _e('Upgrade to Pro', 'busiprof'); ?></a>
    ...
    class WP_Review_Customize_Control extends WP_Customize_Control
    {
        ...
        public function render_content()
        {
            ?>
            <div class="pro-box">
                <a href="<?php echo esc_url('https://wordpress.org/support/view/theme-reviews/busiprof#postform/'); ?>"
                   target="_blank" class="review" id="review_pro"><?php _e('ADD YOUR REVIEW', 'busiprof'); ?></a>
            </div>
            <?php
        }
    }
    ...
    class WP_document_Customize_Control extends WP_Customize_Control
    {
        ...
        public function render_content()
        {
            ?>
            <div class="pro-box">
            <a href="<?php echo esc_url('http://webriti.com/help/'); ?>" target="_blank" class="document"
               id="review_pro"><?php _e('DOCUMENTATION', 'busiprof'); ?></a>
