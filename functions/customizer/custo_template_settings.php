...
function busiprof_template_settings($wp_customize)
{
    ...
    class busiprof_Customize_about_upgrade extends WP_Customize_Control
    {
        ...
        { ?>
            <h3><?php _e('Want to add about us template, team section, or client section? Then', 'busiprof'); ?><a
            href="<?php echo esc_url('http://www.webriti.com/busiprof'); ?>" target="_blank">
...
public function render_content() { ?>
    <h3><?php _e('Want to add service template, testimonial section or client section? Then', 'busiprof'); ?><a
        href="<?php echo esc_url('http://www.webriti.com/busiprof'); ?>" target="_blank">
    <?php _e('Upgrade to Pro', 'busiprof'); ?> </a>
    <?php
}
...
public function render_content() { ?>
    <h3><?php _e('Want to add project templates, like: Project 2 column, 3 column, 4 column, or portfolio categorisation? Then', 'busiprof'); ?>
    <a href="<?php echo esc_url('http://www.webriti.com/busiprof'); ?>"
       target="_blank"><?php _e('Upgrade to Pro', 'busiprof'); ?> </a>
    <?php
}
}
...
public function render_content() { ?>
    <h3><?php _e('Want to add contact template, Google Maps or Contact form? Then', 'busiprof'); ?><a
        href="<?php echo esc_url('http://www.webriti.com/busiprof'); ?>" target="_blank">
    <?php _e('Upgrade to Pro', 'busiprof'); ?> </a>
    <?php
}
    ...
    class busiprof_Customize_portfolio_texonomy_upgrade extends WP_Customize_Control
    {
        public function render_content()
        { ?>
            <h3><?php _e('Want to add a taxonomy archive portfolio template? Then', 'busiprof'); ?><a
            href="<?php echo esc_url('http://www.webriti.com/busiprof'); ?>" target="_blank">
            <?php _e('Upgrade to Pro', 'busiprof'); ?> </a>
            <?php
        }
