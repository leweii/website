                            ...
                            <figure class="post-thumbnail">
                                ...
                                <a href="<?php echo esc_url($current_options['project_one_url']); ?>">
                                    ...
                                    <?php if ($current_options['project_thumb_one'] != '') { ?>
                                        <img alt="" src="<?php echo esc_url($current_options['project_thumb_one']); ?>"
                                             class="project_feature_img"/>
                                    <?php } ?></a>
                            </figure>
                            <div class="portfolio-info">
                                <div class="entry-header">
                                    ...
                                    <h4 class="entry-title"><a
                                                href="<?php echo esc_url($current_options['project_one_url']); ?>">
                            ...
                            <figure class="post-thumbnail">
                                ...
                                <a href="<?php echo esc_url($current_options['project_two_url']); ?>">
                                    ...
                                    <?php if ($current_options['project_thumb_two'] != '') { ?>
                                        <img alt="" src="<?php echo esc_url($current_options['project_thumb_two']); ?>"
                                             class="project_feature_img"/>
                                    <?php } ?></a>
                            </figure>
                            <div class="portfolio-info">
                                <div class="entry-header">
                                    <?php if ($current_options['project_two_url'] != '') { ?>
                                    <h4 class="entry-title"><a
                                                href="<?php echo esc_url($current_options['project_two_url']); ?>">
                            ...
                            <figure class="post-thumbnail">
                                ...
                                <a href="<?php echo esc_url($current_options['project_three_url']); ?>">
                                    ...
                                    <?php if ($current_options['project_thumb_three'] != '') { ?>
                                        <img alt=""
                                             src="<?php echo esc_url($current_options['project_thumb_three']); ?>"
                                             class="project_feature_img"/>
                                    <?php } ?></a>
                            </figure>
                            <div class="portfolio-info">
                                <div class="entry-header">
                                    <?php if ($current_options['project_three_url'] != '') { ?>
                                    <h4 class="entry-title"><a
                                                href="<?php echo esc_url($current_options['project_three_url']); ?>">
                            ...
                            <figure class="post-thumbnail">
                                ...
                                <a href="<?php echo esc_url($current_options['project_four_url']); ?>">
                                    ...
                                    <?php if ($current_options['project_thumb_four'] != '') { ?>
                                        <img alt="" src="<?php echo esc_url($current_options['project_thumb_four']); ?>"
                                             class="project_feature_img"/>
                                    <?php } ?></a>
                            </figure>
                            <div class="portfolio-info">
                                <div class="entry-header">
                                    <?php if ($current_options['project_four_url'] != '') { ?>
                                    <h4 class="entry-title"><a
                                                href="<?php echo esc_url($current_options['project_four_url']); ?>">
